...
export function createSuccessResponseSchema(dataSchema, messageExample = "Operasi berhasil!") {
    return z.object({
...
export function createErrorResponseSchema(messageExample) {
    return z.object({
        success: z.boolean().openapi({ example: false }),
        message: z.string().openapi({ example: messageExample }),
        error: z.unknown().optional().openapi({ example: null }),
...
export function getOpenApiDocumentation() {
    ...
    return generator.generateDocument({
        ...
        info: {
            ...
            version: "1.0.0-mvp",
            description: "Dokumentasi Resmi ZII POS REST API (Multi-Tenant & White-Label). Setiap status code (200, 201, 400, 401, 403, 404, 500) memiliki skema JSON response lengkap.",
            contact: {
