...
registry.registerPath({
    ...
    responses: {
        200: {
            ...
            content: {
                "application/json": {
                    schema: createSuccessResponseSchema(TenantSchema, "Berhasil mengambil profil merchant"),
                },
            },
        },
        401: {
        ...
        500: {
            description: "500 Internal Server Error — Kesalahan koneksi database server",
            content: {
                "application/json": {
...
registry.registerPath({
    ...
    responses: {
        200: {
            ...
            content: {
                "application/json": {
                    schema: createSuccessResponseSchema(TenantSchema, "Pengaturan White-Label merchant berhasil disimpan!"),
                },
            },
        },
        400: {
            ...
            content: {
                "application/json": {
                    schema: createErrorResponseSchema("Format data pengaturan merchant tidak valid."),
                },
            },
        },
        401: {
        ...
        403: {
            description: "403 Forbidden — Hanya akun Owner yang memiliki akses ubah profil merchant",
            content: {
                "application/json": {
                    schema: createErrorResponseSchema("Akses ditolak. Hanya Role Owner yang dapat memperbarui profil."),
                },
            },
        },
        500: {
            ...
            content: {
                "application/json": {
                    schema: createErrorResponseSchema("Gagal menyimpan pengaturan merchant."),
                },
            },
        },
    },
