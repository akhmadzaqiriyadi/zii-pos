...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "bg-slate-50 text-xs font-bold uppercase tracking-wider text-slate-500 border-b border-slate-200",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-slate-200 bg-slate-50 font-bold text-slate-900",
      className,
    )}
    {...props}
  />
